...
<div class="policy-content">
    ...
    <div class="formula-box">
        Nhân viên Bán hàng & Hỗ trợ Kỹ thuật Cầu lông
    </div>
    ...
    <ul>
        ...
        <li>Yêu thích thể thao, đặc biệt là cầu lông.</li>
    ...
    <div class="formula-box">
        Địa điểm làm việc: Số 72, phố Văn Giang, Xã Văn Giang, Tỉnh Hưng Yên, Việt Nam
    </div>
    ...
    <p>
        Hotline tuyển dụng: 0973 359 165
    </p>
    ...
    <ul>
        <li>CV xin việc.</li>
        <li>Thông tin liên hệ cá nhân.</li>
        <li>01 video đánh cầu lông (nếu có) để cửa hàng đánh giá mức độ yêu thích và kinh nghiệm chơi cầu lông của ứng viên.</li>
    </ul>

    <p>
        Hồ sơ vui lòng gửi qua Zalo: <strong>0973 359 165</strong>.
    </p>
